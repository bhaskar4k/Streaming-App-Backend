...
//    private String encodedVideoPath = "D:" + File.separator + "Streaming-App-Data" + File.separator + "Streaming-App-Resized-Video";
    ...
    // Laptop
//    private String pythonScriptPath = "D:" + File.separator + "Streaming-App-Backend" + File.separator + "processing" + File.separator +
...
//            "app" + File.separator + "processing" + File.separator + "python" + File.separator + "VideoSplitter.py";
    ...
    public String getUpdateVideoProcessingStatusURL() {
        return updateVideoProcessingStatusURL;
    }
}